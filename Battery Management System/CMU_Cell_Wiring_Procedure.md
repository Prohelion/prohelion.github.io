...
{% include image.html file="imps_cmu.jpg" alt="imps_cmu" %}
...
{% include image.html file="imps_pinout.gif" alt="imps_pinout" %}
...
{% include image.html file="imps_connection.png" alt="imps_connections" %}
...
{% include image.html file="imps_cuttolength.jpg" alt="imps_cuttolength" %}
...
{% include image.html file="imps_split.jpg" alt="imps_split" %}
...
{% include image.html file="imps_cmuend.png" alt="imps_cmuend" %}
...
{% include image.html file="imps_stripbranches.jpg" alt="imps_stripbranches" %}

Fold back the stripped length, as shown below:

{% include image.html file="imps_fold.png" alt="imps_fold" %}
...
{% include image.html file="imps_fitcrimp.jpg" alt="imps_fitcrimp" %}
