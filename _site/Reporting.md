...
<p>Note that for more advanced reporting we would suggest using the <a href="Splunk.md">Integration with Splunk</a> which allows you to do very complex and rich reporting.</p>
