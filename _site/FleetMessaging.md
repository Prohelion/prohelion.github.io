...
<p>This system works with the <a href="../ArrowPoint_Tablet/Overview.md">ArrowPoint Tablet application</a>, allowing messages to be sent to Tablets in the fleet.  Messages are sent via CANbus.</p>
