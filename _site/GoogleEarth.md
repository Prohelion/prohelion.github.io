...
<!DOCTYPE html>
	...
	<head>
		...
		<meta name="viewport" content="width=device-width, minimum-scale=1.0">
			...
			<title>ArrowPoint Telemetry Google Earth | Prohelion</title>
		
		
		
			<meta name="keywords" content="ArrowPoint, Telemetry, Google Earth">
...
<p>When <a href="GPSIntegration.html">GPS Integration</a> is enabled, the car itself will appear on the map showing your current location.</p>
