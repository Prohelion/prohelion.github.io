...
When running Profinity on [Docker](../../Getting_Started/Installation.md#installation-using-docker) additional support is also provided for the native SocketCAN Adapter.
