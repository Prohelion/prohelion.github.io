...
Consult the [BMU documentation](../Battery_Management_Systems/Overview.md) for more information but note that that error state can be part of normal operation.
