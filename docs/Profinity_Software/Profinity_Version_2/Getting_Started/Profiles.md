...
You can see the components that are in your Profile in the menu on the left of the screen, and you can add to the Profile by clicking on the [+ ADD COMPONENT](./Adding_New_Components.md) button in the left-most menu of Profinity or on the home page.
