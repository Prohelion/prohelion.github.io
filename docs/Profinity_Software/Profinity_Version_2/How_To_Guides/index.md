...
- [How to Create a Custom Component](./Create_Custom_Component.md) - Add a new CAN bus device using DBC files
- [How to Add a Component to Your Profile](./Add_Component_to_Profile.md) - Configure and add components to your active profile

## CAN Bus Guides

- [How to Connect to CAN Bus](./Connect_to_CAN_Bus.md) - Connect Profinity to your CAN bus network
- [How to Send and Receive CAN Bus Messages](./Send_Receive_CAN_Bus.md) - Send and receive CAN messages using Profinity
...
- [How to Create a New Profile](./Create_New_Profile.md) - Set up a new profile for a different configuration
- [How to Configure Environment Variables](./Configure_Environment_Variables.md) - Use environment variables for flexible deployments
- [How to Set Up Profinity as a Kiosk Application](./Set_Up_Profinity_as_Kiosk.md) - Configure kiosk mode for fullscreen displays
